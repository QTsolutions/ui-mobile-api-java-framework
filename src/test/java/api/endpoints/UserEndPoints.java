...
public class UserEndPoints {
    ...
    static String json_schema_path = PropFileHandler.readProperty("json_schema_path");
    static String faker_json_path = PropFileHandler.readProperty("faker_json_path");
